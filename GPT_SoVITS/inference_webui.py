    ...
    for i_text, text in enumerate(texts):
        ...
        if model_version not in v3v4set:
            ...
            if last_attn is not None:
                ...
                # aggregate normalized text ↔ original text segments
                norm_text_seg, ph_to_segment_map, segment_infos, original_text_seg, segment_details = build_mixed_mappings(
                    text,
                    text_language,
                    version,
                    clean_text_inf,
                ...
                if segment_infos:
                    ...
                    for seg in segment_infos:
                        segment_entries.append({
                            ...
                            "text_norm_indices": seg.get("text_norm_indices", (seg.get("norm_start", 0), seg.get("norm_end", 0))),
                            "start_s": None,
                            "end_s": None,
                        })
